...
@section('title', 'Editar Cadastro de Contato')
        ...
        <div class="card card-lightblue">
            <div class="card-header">
                <div class="row">
                    ...
                    <a href="{{ asset('help/Contatos/packages/Lista_De_Contatos.html#subsection-2') }}" target="_blank"
                        class="logo_help" title="Abrir página de help para editar Contato cadastrado">
                        <i class="fas fa-question-circle fa-1" style="color: #ffffff;"></i>
                    </a>


                </div>
            </div>
            <form id="contact_form" action="{{ route('contato.update', ['contato' => $contact->id]) }}" method="POST">
                {{ method_field('PUT') }}
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-12 contact-name">
                            <div class="col form-group">
                                ...
                                <input class="col-12 form-control" type="text" name="name" minlength="3" maxlength="50"
                                    placeholder="Nome..." tabindex="1" value="{{ $contact->name ?? '' }}" id="name"
                                    required autofocus>
                        ...
                        <div class="col-12 contact-email">
                            <div class="col form-group">
                                ...
                                <input class="col-12 form-control" type="email" name="email" minlength="3" maxlength="255"
                                    placeholder="Endereço de e-mail..." tabindex="2" value="{{ $contact->email ?? '' }}"
                                    id="email" required>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col text-right float-right">
                                        ...
                                        <input type="checkbox" id="change_phone" class="form-check-input" tabindex="3"
                                            name="international_phone" onclick="setTypePhone('edit')"
                                            {{ $contact->international_phone ? 'checked' : '' }} />
                                    </div>
                                </div>
                                <input class="col-12 form-control phone" type="tel" name="phone" minlength="10"
                                    onblur="mask(this, mphone);" placeholder="(42) 99999-9999"
                                    oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                                    maxlength="15" tabindex="4" value="{{ $contact->phone ?? '' }}" id="phone">
                                <div id="phone_int" hidden>
                                    <input class="col-12 form-control phone_int" type="tel" id="phone_international"
                                        onblur="setPhoneInt('edit')"
                                        oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                                        value="{{ $contact->phone ?? '' }}" size="100" name="phone_int"
                                        tabindex="4" minlength="6" maxlength="20">
                                    <span id="valid-msg-edit" style="color: rgb(80, 158, 80); font-weight: bold" hidden>
                                        <i class="fas fa-check"></i> Número de telefone Válido</span>
                                    <span id="error-msg-edit" style="color: rgb(211, 47, 47); font-weight: bold"></span>
...
@section('js')
    <script>
        window.onload = function() {
            setTypePhone('edit');
            mask(document.getElementById('phone'), mphone);
        };
    </script>
